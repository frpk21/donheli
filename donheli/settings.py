"""
Django settings for donheli project.
...
SECRET_KEY = 'django-insecure-sy(2#f4vjhw%%b)&1ro$qxd1h(ap#3f8eoe1$mk#n3m%=!i&0z'
...
WSGI_APPLICATION = 'donheli.wsgi.application'
